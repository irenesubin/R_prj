##4 무조건해보기
#4.1 X-Y 플로팅 차트로 보는 지역별 미세먼지 근황

city<-c("서울", "부산",  "대구", "인천", "광주"," 대전", "울산")
pm25<-c(14,8,7,22,10,13,9)
...
img_path<-"D://Bigdata/pinwheel.png"
...
url<- "http://apis.data.go.kr/9760000/CountingSttnInfoInqireService"
html<- read_html(url)
html
...
#P352-353 보기 (대수의 법칙)
#P353 그래프 3번 앞에 xpathSApply()지우기
iteration <-5000
plot(0,0,xlab="동전을 던진 회수", ylab="앞면이 나오는 비율",
     xlim=c(0,iteration), abline(a=0.5,b=0, col="red"))
